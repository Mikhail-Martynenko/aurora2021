...
let SteeringArrivalScene = new Phaser.Class({
  ...
  create: function () {
    ...
    const npc = this.characterFactory.buildNPCCharacter('yellow', 200, 200, {steering: "arrival", target: this.player});
    ...
    for (let i = 0; i < 15; i++) {
      ...
      this.physics.add.collider(slime, npc);
     // this.physics.add.collider(slime, this.slimes);
    }
